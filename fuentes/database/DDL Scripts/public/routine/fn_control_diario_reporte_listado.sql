create or replace function public.fn_control_diario_reporte_listado(_process_date_from character varying, _process_date_to character varying, _correlativo integer) returns SETOF control_diario_reporte
    language plpgsql
as
$$
    BEGIN
