create table public.tbvw_maestro_cuentas_pershing
(
    id                                            bigint,
    ...
    estado_cuenta                                 varchar(100)    default NULL::character varying,
    portfolio                                     varchar(100)    default NULL::character varying,
    constraint pk_tbvw_maestro_cuentas_pershing_row_no
        primary key (row_no)
);
