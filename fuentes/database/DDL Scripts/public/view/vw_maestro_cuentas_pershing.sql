create or replace view public.vw_maestro_cuentas_pershing
            (id, custodian, id_interno_cliente, client_id, name, id_tipo_identificador_cliente,
             tipo_identificador_cliente, glosa_identificador_cliente, id_interno_cuenta, id_custodio,
             id_cuenta_custodio, habilitado, fee, ibd_number, id_office, ip_number, account_no, id_proceso,
             process_date, record_id_sequence_number, account_short_name, full_name, full_address, transaction_type,
...
alter table public.vw_maestro_cuentas_pershing
    owner to postgres;
