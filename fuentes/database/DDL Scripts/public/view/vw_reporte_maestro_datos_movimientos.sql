create or replace view public.vw_reporte_maestro_datos_movimientos
            (row_id, src_vw, id_reg, tipo_reg, custodian, client_id, tipo_identificador_cliente, account_no, name,
             process_date, trade_date, settlement_date, activity, buy_sell, quantity, price, comission, fees,
             net_amount, usde_net_amount, principal, cusip, symbol, isin, currency, fx_rate, interest, currency_base,
             cash_margin_account, product_type, security_description, activity_description, activity_code, source_code,
