create or replace function stage_pershing.fn_extrae_acct_reg_e(_id_proceso bigint)
...
alter function stage_pershing.fn_extrae_acct_reg_e(bigint) owner to postgres;
