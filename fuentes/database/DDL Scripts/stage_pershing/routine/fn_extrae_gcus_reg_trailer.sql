create or replace function stage_pershing.fn_extrae_gcus_reg_trailer(_id_proceso bigint)
...
alter function stage_pershing.fn_extrae_gcus_reg_trailer(bigint) owner to postgres;
