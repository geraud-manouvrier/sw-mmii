create or replace function stage_pershing.fn_parse_isca_reg_header(_id_proceso bigint) returns SETOF stage_pershing.stage_isca_reg_header
    language plpgsql
as
$$
    BEGIN
...
alter function stage_pershing.fn_parse_isca_reg_header(bigint) owner to postgres;
