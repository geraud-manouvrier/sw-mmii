create or replace function stage_pershing.fn_extrae_gact_reg_trailer(_id_proceso bigint)
...
alter function stage_pershing.fn_extrae_gact_reg_trailer(bigint) owner to postgres;
