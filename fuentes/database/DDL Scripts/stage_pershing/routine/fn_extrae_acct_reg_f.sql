create or replace function stage_pershing.fn_extrae_acct_reg_f(_id_proceso bigint)
...
alter function stage_pershing.fn_extrae_acct_reg_f(bigint) owner to postgres;
