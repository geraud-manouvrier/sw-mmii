create or replace function stage_pershing.fn_extrae_isrc_reg_header(_id_proceso bigint)
...
alter function stage_pershing.fn_extrae_isrc_reg_header(bigint) owner to postgres;
