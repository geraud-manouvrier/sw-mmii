...
@Component
public class JobUpdateFromRiaFee extends CustomJob {
    ...
    @Autowired
    public JobUpdateFromRiaFee(AppConfig appConfig, CalendarioHelper calendarioHelper, NotificacionEmail notificacionEmail, ApiRestClientService apiRestClientService, EnrolamientoClientesService enrolamientoClientesService, ReporteMaestroDatosService reporteMaestroDatosService) {
