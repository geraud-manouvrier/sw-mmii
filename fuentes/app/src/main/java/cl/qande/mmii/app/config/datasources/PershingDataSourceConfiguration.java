...
@EnableJpaRepositories(basePackages = PershingDataSourceConfiguration.PACKAGE_DAO,
        entityManagerFactoryRef = PershingDataSourceConfiguration.ENTITY_MANAGER,
        transactionManagerRef= PershingDataSourceConfiguration.TRANSACTION_MANAGER
)
public class PershingDataSourceConfiguration {

    @Autowired
    private AppDatasourceProperties dsProperties;
    public static final String PACKAGE_ENTITIES     = "cl.qande.mmii.app.models.db.pershing.entity";
    public static final String PACKAGE_DAO          = "cl.qande.mmii.app.models.db.pershing.dao";
    public static final String NOMBRE_DATASOURCE    = "pershingDataSource";
    public static final String ENTITY_MANAGER       = "pershingEntityManagerFactory";
    public static final String TRANSACTION_MANAGER  = "pershingTransactionManager";
    public static final String DATASOURCE_PROPERTIES    = "pershingDataSourceProperties";
    @Bean(name=DATASOURCE_PROPERTIES)
    public DataSourceProperties createDataSourceProperties() {
        var dataSourceConfiguration= dsProperties.getDbpershing();
