...
@Entity
@Table(name = "consolidado_agregado_n1", schema = "rep_inv")
public class ConsolidadoAgregadoN1 {
    @EmbeddedId
    private ConsolidadoAgregadoN1Id id;
    ...
    public ConsolidadoAgregadoN1Id getId() {
        return id;
    }

    public void setId(ConsolidadoAgregadoN1Id id) {
        this.id = id;
    }
