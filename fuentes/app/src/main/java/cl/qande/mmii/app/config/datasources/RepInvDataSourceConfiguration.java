...
@EnableJpaRepositories(basePackages = RepInvDataSourceConfiguration.PACKAGE_DAO,
        entityManagerFactoryRef = RepInvDataSourceConfiguration.ENTITY_MANAGER,
        transactionManagerRef= RepInvDataSourceConfiguration.TRANSACTION_MANAGER
)
public class RepInvDataSourceConfiguration {

    @Autowired
    private AppDatasourceProperties dsProperties;
    public static final String PACKAGE_ENTITIES     = "cl.qande.mmii.app.models.db.rep_inv.entity";
    public static final String PACKAGE_DAO          = "cl.qande.mmii.app.models.db.rep_inv.dao";
    public static final String NOMBRE_DATASOURCE    = "repInvDataSource";
    public static final String ENTITY_MANAGER       = "repInvEntityManagerFactory";
    public static final String TRANSACTION_MANAGER  = "repInvTransactionManager";
    public static final String DATASOURCE_PROPERTIES    = "repInvDataSourceProperties";
    @Bean(name=DATASOURCE_PROPERTIES)
    public DataSourceProperties createDataSourceProperties() {
        var dataSourceConfiguration= dsProperties.getDbrepinv();
