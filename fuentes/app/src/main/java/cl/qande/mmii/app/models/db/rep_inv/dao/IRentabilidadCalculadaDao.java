...
public interface IRentabilidadCalculadaDao extends CrudRepository<RentabilidadCalculada, Long> {
    ...
    @Query(value = "select * from rep_inv.fn_precalculo_diario(:_start_process_date, :_end_process_date)", nativeQuery = true)
    public String preCalculoDiario(@Param("_start_process_date") String startProcessDate, @Param("_end_process_date") String endProcessDate);
}